...
function WhatsupdockerWidgetFields({ initialData, onChange: parentOnChange }) {
  ...
  useEffect(() => {
    ...
    const dataForParent = { type: 'whatsupdocker' };
    ...
    if (Object.keys(dataForParent).length === 0) {
        dataForParent.type = 'whatsupdocker';
    }
  ...
  return (
    <Box sx={{ mt: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
      <TextField
        ...
        helperText={fieldErrors.url || "e.g., http://192.168.1.101:8080"}
      />
...
WhatsupdockerWidgetFields.propTypes = {
...
WhatsupdockerWidgetFields.defaultProps = {
  initialData: null,
};

export default WhatsupdockerWidgetFields;