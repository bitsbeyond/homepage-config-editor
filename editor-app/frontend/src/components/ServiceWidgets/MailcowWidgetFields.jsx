...
const WIDGET_TYPE = 'mailcow';

function MailcowWidgetFields({ initialData, onChange: parentOnChange }) {
  ...
  return (
    <Box sx={{ paddingTop: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
      <TextField
        ...
        helperText={fieldErrors.url || "e.g., https://mailcow.example.com"}
      />
      <EnvVarAutocompleteInput
        ...
        helperText={fieldErrors.key || "Your Mailcow API Key"}
      />
    </Box>
  );
}

MailcowWidgetFields.propTypes = {
...
MailcowWidgetFields.defaultProps = {
  initialData: null,
};

export default MailcowWidgetFields;